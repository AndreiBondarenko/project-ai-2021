...
def parser():
    _parser = argparse.ArgumentParser(description='Run Matrix Factorization with Implicit Feedback Experiment on Shared Subset.')
...
if __name__ == '__main__':
    ...
    train_sets = [sps.load_npz(f'./group/train{i}.npz') for i in range(1, 6)]
    test_sets = [sps.load_npz(f'./group/test{i}.npz') for i in range(1, 6)]
